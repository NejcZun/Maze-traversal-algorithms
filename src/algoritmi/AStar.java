...
public class AStar {
    ...
    private List<Point> AStarPath() {
        ...
        f_score[this.start.x][this.start.y] = h_score[this.start.x][this.start.y];
            ...
            for (int[] direction : DIRECTIONS) {
                ...
                if(isValid(nextNode.x, nextNode.y) && !isWall(nextNode.x, nextNode.y) && !closed_bool[nextNode.x][nextNode.y]){
                    ...
                    if(dist < g_score[nextNode.x][nextNode.y]){
                        ...
                        f_score[nextNode.x][nextNode.y] = g_score[nextNode.x][nextNode.y] + h_score[nextNode.x][nextNode.y];
